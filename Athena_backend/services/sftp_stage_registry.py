...
SFTP_STAGE_SPECS: Tuple[SftpStageSpec, ...] = (
    _stage("brd_ingestion", "SFTP_NB01_DL_BRD_Ingestion.py", "BRD Ingest", "phase-1", "brd_ingestion_status", "SFTP_BRD_INGESTION"),
    ...
    _stage("gate1", "SFTP_NB05_HITL_Gate1.py", "KPI Review", "phase-1", "gate1_status", "SFTP_APPROVED_KPIS", 1),
    ...
    _stage("gate2", "SFTP_NB06c_HITL_Gate2.py", "Feed Review", "phase-2", "gate2_status", "SFTP_GATE2_DECISION", 2),
    ...
    _stage("gate3", "SFTP_NB09b_HITL_Gate3.ipynb", "Semantic Review", "phase-2", "gate3_status", "GATE3_APPROVED_ENRICHMENT", 3),
    ...
    _stage("gate4_metadata", "SFTP_NB10c_HITL_Gate4_Metadata.py", "Metadata Code Review", "phase-3", "gate4_metadata_status", "SFTP_GATE4_METADATA_DECISION", 4),
    _stage("dab_bundle", "SFTP_NB22_Generate_DAB_Bundle.py", "Generate Runtime Bundle", "phase-3", "dab_bundle_status", "SFTP_DAB_BUNDLE"),
    ...
    _stage("stage_to_landing", "SFTP_NB14_Stage_To_Landing.py", "Stage Files to Landing", "phase-4", "stage_to_landing_status", "SFTP_LANDING_MANIFEST"),
    _stage("bronze_autoloader", "SFTP_NB15_Bronze_AutoLoader.ipynb", "Bronze Ingestion", "phase-4", "bronze_execution_status", "SFTP_BRONZE_EXECUTION"),
    _stage("bronze_dq", "SFTP_NB16_Bronze_DQ.py", "Bronze Data Quality", "phase-4", "bronze_dq_status", "SFTP_BRONZE_DQ"),
    _stage("bronze_to_silver", "SFTP_NB17_Bronze_To_Silver_Merge.py", "Silver Transformation", "phase-5", "silver_execution_status", "SFTP_SILVER_EXECUTION"),
    _stage("silver_dq", "SFTP_NB18_Silver_DQ.py", "Silver Data Quality", "phase-5", "silver_dq_status", "SFTP_SILVER_DQ"),
    _stage("silver_to_gold", "SFTP_NB19_Silver_To_Gold_Merge.py", "Gold Model Build", "phase-6", "gold_execution_status", "SFTP_GOLD_EXECUTION"),
    _stage("gold_dq", "SFTP_NB20_Gold_DQ.py", "Gold Data Quality", "phase-6", "gold_dq_status", "SFTP_GOLD_DQ"),
    _stage("gate5_publish", "SFTP_NB20b_HITL_Gate5.py", "Final Publish Review", "phase-6", "gate5_publish_status", "SFTP_GATE5_PUBLISH_DECISION", 5),
    _stage("finalize", "SFTP_NB21_Finalize_Run.py", "Finalize Run", "phase-6", "finalization_status", "SFTP_RUN_FINALIZATION"),
)
