...
def _stage(
    ...
    return SftpStageSpec(
        ...
        operations=operations or (notebook,),
    )


# The UI defines graph-node boundaries. The approved notebook flow remains the
# required operation contract inside these nodes; grouping does not skip work.
SFTP_STAGE_SPECS: Tuple[SftpStageSpec, ...] = (
    ...
    _stage("feed_discovery", "SFTP_NB06_Feed_Discovery.py", "Feed Discovery", "phase-2", "feed_discovery_status", "SFTP_FEED_DISCOVERY"),
    ...
    _stage("column_extraction", "SFTP_NB07_Metadata_Discovery.py", "Column Extraction", "phase-2", "metadata_discovery_status", "SFTP_SCHEMA_SNAPSHOT"),
    _stage("freshness_check", "SFTP_NB07b_Freshness_Check.py", "Freshness Check", "phase-2", "freshness_check_status", "SFTP_FRESHNESS_MANIFEST"),
    ...
    _stage("gate3", "SFTP_NB09b_HITL_Gate3.ipynb", "Semantic Review", "phase-2", "enrichment_review_status", "GATE3_APPROVED_ENRICHMENT", 3, "complete"),
    _stage("plan_seal", "SFTP_NB09c_Plan_Seal_Check.py", "Plan Seal Check", "phase-2", "plan_seal_status", "SFTP_SEALED_PLAN"),
    ...
    _stage(
        "gate4_metadata",
        "SFTP_NB10c_HITL_Gate4_Metadata.py",
        "Metadata Codegen Review",
        "phase-3",
        "gate4_metadata_status",
        "SFTP_GATE4_METADATA_DECISION",
        4,
        "complete",
        (
            "SFTP_NB10c_HITL_Gate4_Metadata.py",
            "SFTP_NB22_Generate_DAB_Bundle.py",
        ),
    ),
    _stage("runtime_config", "SFTP_NB11_Load_Runtime_Config.py", "Load Runtime Config", "phase-3", "runtime_config_status", "SFTP_RUNTIME_CONFIG"),
    _stage("validate_source", "SFTP_NB12_Validate_Source.py", "Validate Source", "phase-3", "source_validation_status", "SFTP_SOURCE_VALIDATION"),
    _stage("discover_source_objects", "SFTP_NB13_Discover_Source_Objects.py", "Discover Source Objects", "phase-3", "source_object_discovery_status", "SFTP_RUNTIME_OBJECT_DISCOVERY"),
    _stage("stage_to_landing", "SFTP_NB14_Stage_To_Landing.py", "Stage To Landing", "phase-3", "stage_to_landing_status", "SFTP_LANDING_MANIFEST", checkpoint_policy="before_after"),
