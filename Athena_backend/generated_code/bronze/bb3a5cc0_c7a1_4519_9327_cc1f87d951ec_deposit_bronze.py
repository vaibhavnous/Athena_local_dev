...
SOURCE_FEED = "Vendor1/Deposit"
FILE_FORMAT = "xml"
ROW_TAG = "RemoteMessage"
SOURCE_PATH = "abfss://athena@atheastorage.dfs.core.windows.net/evention/vendor1/machine1/Deposit/"
TARGET_TABLE = "bronze.vendor1_deposit_raw"
SCHEMA_LOCATION = "/Volumes/main/bronze/pipeline_artifacts/schemas/bronze/vendor1/deposit"
CHECKPOINT_PATH = "/Volumes/main/bronze/pipeline_artifacts/checkpoints/bronze/vendor1/deposit"
...
bronze_df = df.select(
    ...
    _project_column(available_columns, "RemoteMessage_Details_Currency", "string"),
    _project_column(available_columns, "RemoteMessage_Details_countings_counted_denom", "string"),
    _project_column(available_columns, "RemoteMessage_Details_countings_counted_quantity", "string"),
    _project_column(available_columns, "RemoteMessage_Details_countings_counted_type", "string"),
    _project_column(available_columns, "RemoteMessage_Details_countings_valid", "long"),
    _project_column(available_columns, "RemoteMessage_Details_total", "long"),
    ...
    _project_column(available_columns, "RemoteMessage_TransactionID", "long"),
    _project_column(available_columns, "RemoteMessage_User", "long"),
    _project_column(available_columns, "RemoteMessage_UserLevel", "long"),
    _project_column(available_columns, "RemoteMessage_UserName", "string"),
    _project_column(available_columns, "RemoteMessage_accountingDate", "timestamp"),
    _project_column(available_columns, "RemoteMessage_authenticationMode", "string"),
    _project_column(available_columns, "RemoteMessage_contentAfter_count_N", "string"),
    _project_column(available_columns, "RemoteMessage_contentAfter_count_curr", "string"),
    _project_column(available_columns, "RemoteMessage_contentAfter_count_den", "string"),
    _project_column(available_columns, "RemoteMessage_contentAfter_count_machineId", "string"),
    _project_column(available_columns, "RemoteMessage_contentAfter_count_qty", "string"),
    _project_column(available_columns, "RemoteMessage_contentAfter_count_sType", "string"),
    _project_column(available_columns, "RemoteMessage_contentAfter_count_type", "string"),
    _project_column(available_columns, "RemoteMessage_contentBefore_count_N", "string"),
    _project_column(available_columns, "RemoteMessage_contentBefore_count_curr", "string"),
    _project_column(available_columns, "RemoteMessage_contentBefore_count_den", "string"),
    _project_column(available_columns, "RemoteMessage_contentBefore_count_machineId", "string"),
    _project_column(available_columns, "RemoteMessage_contentBefore_count_qty", "string"),
    _project_column(available_columns, "RemoteMessage_contentBefore_count_sType", "string"),
    _project_column(available_columns, "RemoteMessage_contentBefore_count_type", "string"),
    _project_column(available_columns, "RemoteMessage_destDetails_count_N", "string"),
    _project_column(available_columns, "RemoteMessage_destDetails_count_curr", "string"),
    _project_column(available_columns, "RemoteMessage_destDetails_count_den", "string"),
    _project_column(available_columns, "RemoteMessage_destDetails_count_machineId", "string"),
    _project_column(available_columns, "RemoteMessage_destDetails_count_qty", "string"),
    _project_column(available_columns, "RemoteMessage_destDetails_count_sType", "string"),
    _project_column(available_columns, "RemoteMessage_destDetails_count_type", "string"),
    _project_column(available_columns, "RemoteMessage_endShiftDeposit", "long"),
    _project_column(available_columns, "RemoteMessage_groupID", "long"),
    _project_column(available_columns, "RemoteMessage_groupName", "string"),
    _project_column(available_columns, "RemoteMessage_isKit", "long"),
