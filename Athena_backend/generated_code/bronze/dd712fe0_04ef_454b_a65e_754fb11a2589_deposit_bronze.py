...
RUN_ID = "dd712fe0-04ef-454b-a65e-754fb11a2589"
PIPELINE_VERSION = "v1"
...
bronze_df = df.select(
    _project_column(available_columns, "RemoteMessage_Details__Currency", "string"),
    _project_column(available_columns, "RemoteMessage_Details_countings__valid", "long"),
    _project_column(available_columns, "RemoteMessage_Details_countings_counted", "string"),
    ...
    _project_column(available_columns, "RemoteMessage__CustomerCode", "string"),
    _project_column(available_columns, "RemoteMessage__Date", "timestamp"),
    _project_column(available_columns, "RemoteMessage__DeviceID", "string"),
    _project_column(available_columns, "RemoteMessage__NOP", "long"),
    _project_column(available_columns, "RemoteMessage__TestMode", "long"),
    _project_column(available_columns, "RemoteMessage__Time", "timestamp"),
    _project_column(available_columns, "RemoteMessage__operation", "string"),
    ...
    _project_column(available_columns, "RemoteMessage_contentAfter_count", "string"),
    _project_column(available_columns, "RemoteMessage_contentBefore_count", "string"),
    _project_column(available_columns, "RemoteMessage_destDetails_count", "string"),
