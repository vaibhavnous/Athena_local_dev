...
SCHEMA_LOCATION = "/Volumes/main/bronze/pipeline_artifacts/schemas/bronze/vendor1/withdrawal"
CHECKPOINT_PATH = "/Volumes/main/bronze/pipeline_artifacts/checkpoints/bronze/vendor1/withdrawal"
...
bronze_df = df.select(
    ...
    _project_column(available_columns, "RemoteMessage_sourceDetails_count_N", "string"),
    _project_column(available_columns, "RemoteMessage_sourceDetails_count_curr", "string"),
    _project_column(available_columns, "RemoteMessage_sourceDetails_count_den", "string"),
    _project_column(available_columns, "RemoteMessage_sourceDetails_count_machineId", "string"),
    _project_column(available_columns, "RemoteMessage_sourceDetails_count_qty", "string"),
    _project_column(available_columns, "RemoteMessage_sourceDetails_count_rejects", "string"),
    _project_column(available_columns, "RemoteMessage_sourceDetails_count_sType", "string"),
    _project_column(available_columns, "RemoteMessage_sourceDetails_count_type", "string")
)
