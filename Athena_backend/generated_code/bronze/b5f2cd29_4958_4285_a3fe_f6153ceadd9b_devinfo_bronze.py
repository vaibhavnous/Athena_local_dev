...
EXPECTED_COLUMNS = [
    "RemoteMessage_sw",
    "RemoteMessage_os",
    "RemoteMessage_machineId",
    "RemoteMessage_fw",
    "RemoteMessage_RecFw",
    "RemoteMessage_RecTemplates",
    "RemoteMessage_model",
    "RemoteMessage_stocksConfig",
    "RemoteMessage_bagsConfig",
    "RemoteMessage_videoPack",
...
EXPECTED_TYPES = {
    "RemoteMessage_sw": "double",
    "RemoteMessage_os": "string",
    "RemoteMessage_machineId": "long",
    "RemoteMessage_fw": "string",
    "RemoteMessage_RecFw": "double",
    "RemoteMessage_RecTemplates": "long",
    "RemoteMessage_model": "long",
    "RemoteMessage_stocksConfig": "double",
    "RemoteMessage_bagsConfig": "long",
    "RemoteMessage_videoPack": "double",
