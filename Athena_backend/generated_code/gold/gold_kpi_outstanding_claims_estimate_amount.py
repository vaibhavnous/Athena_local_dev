...
KPI: Outstanding Claims Estimate Amount
Source table: silver.silver_expenses_outstanding_estimates
Target table: gold.fact_outstanding_claims_estimate_amount
...
KPI_NAME = 'Outstanding Claims Estimate Amount'
SOURCE_TABLE = 'silver.silver_expenses_outstanding_estimates'
TARGET_TABLE = 'gold.fact_outstanding_claims_estimate_amount'
VALUE_COLUMN = 'outstanding_claims_estimate_amount_value'
SILVER_SCHEMA = 'silver'
SOURCE_LOGICAL_TABLE = 'expenses_outstanding_estimates'
MEASURE_COLUMN = 'ClaimID'
MEASURE_AGGREGATION = 'SUM'
DIMENSION_COLUMNS = ['InsertedDate', 'BEGIN_DATE', 'END_DATE', 'POLICY_ISSUED_DATE']
DIMENSION_SPECS = []
...
agg_expr = sum(col('ClaimID')).alias('outstanding_claims_estimate_amount_value')
