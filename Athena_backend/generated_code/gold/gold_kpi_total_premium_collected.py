...
KPI: Total Premium Collected
Source table: silver.silver_policy_cover_level_transactions
Target table: gold.fact_total_premium_collected
...
RUN_ID = '18dfc3c0-c3d9-4a20-8667-5b73088efd80'
KPI_NAME = 'Total Premium Collected'
SOURCE_TABLE = 'silver.silver_policy_cover_level_transactions'
TARGET_TABLE = 'gold.fact_total_premium_collected'
VALUE_COLUMN = 'total_premium_collected_value'
SILVER_SCHEMA = 'silver'
SOURCE_LOGICAL_TABLE = 'policy_cover_level_transactions'
MEASURE_COLUMN = 'PREMIUM'
MEASURE_AGGREGATION = 'SUM'
DIMENSION_COLUMNS = ['InsertedDate', 'BEGIN_DATE', 'END_DATE', 'POLICY_ISSUED_DATE', 'COVER_NAME', 'GEOG_STATE_NAME', 'COVER_GROUP_IDENTIFIER_NAME', 'GEOG_ZONE', 'COVERAGE_CATEGORY']
...
agg_expr = sum(col('PREMIUM')).alias('total_premium_collected_value')
