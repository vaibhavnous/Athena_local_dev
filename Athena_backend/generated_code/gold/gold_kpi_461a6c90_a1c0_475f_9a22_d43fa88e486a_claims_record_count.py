...
KPI: Claims Record Count
Source table: silver.silver_policy_transactions
Target table: gold.fact_claims_record_count
...
agg_expr = count(lit(1)).alias('claims_record_count_value')
