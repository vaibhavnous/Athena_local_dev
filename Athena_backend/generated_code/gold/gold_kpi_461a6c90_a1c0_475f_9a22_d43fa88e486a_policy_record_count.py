...
KPI: Policy Record Count
Source table: silver.silver_policy_transactions
Target table: gold.fact_policy_record_count
...
KPI_NAME = 'Policy Record Count'
SOURCE_TABLE = 'silver.silver_policy_transactions'
TARGET_TABLE = 'gold.fact_policy_record_count'
VALUE_COLUMN = 'policy_record_count_value'
...
agg_expr = count(lit(1)).alias('policy_record_count_value')
