...
KPI: Average Claim Amount
Source table: silver.silver_expenses_outstanding_estimates
Target table: gold.fact_average_claim_amount
...
KPI_NAME = 'Average Claim Amount'
SOURCE_TABLE = 'silver.silver_expenses_outstanding_estimates'
TARGET_TABLE = 'gold.fact_average_claim_amount'
VALUE_COLUMN = 'average_claim_amount_value'
...
agg_expr = avg(col('ClaimID')).alias('average_claim_amount_value')
