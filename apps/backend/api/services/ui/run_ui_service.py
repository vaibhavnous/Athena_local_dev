...
def build_ui_payload(
    *,
    ...
    payload = {
        ...
        "use_domain_knowledge_base": bool(checkpoint.get("use_domain_knowledge_base")),
        ...
        "generation_first_execution": bool(context.get("generation_first_execution")),
        ...
        "run_report": context.get("run_report") or checkpoint.get("run_report") or {},
        ...
        "started_at": checkpoint.get("started_at") or (summary[0].get("stored_at") if summary else None),
        "completed_at": checkpoint.get("completed_at") or (summary[-1].get("stored_at") if status == "SUCCESS" and summary else None),
        ...
        "updated_at": checkpoint.get("updated_at") or checkpoint.get("checkpoint_at") or (summary[-1].get("stored_at") if summary else None),
