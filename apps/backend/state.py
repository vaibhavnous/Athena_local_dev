...
class Stage01State(TypedDict, total=False):
    ...
    source_connection_config_version: Optional[int]
    source_connection_config_hash: Optional[str]
    metadata_ddl_artifact: Optional[Dict[str, Any]]
    metadata_ddl_generation_status: Optional[str]
    metadata_setup_execution_status: Optional[str]
    ingestion_objects: Optional[List[Dict[str, Any]]]
    source_to_bronze_mapping_bundles: Optional[List[Dict[str, Any]]]
    ...
    silver_merge_key_resolution_status: Optional[str]
    silver_merge_key_resolution_artifact: Optional[Dict[str, Any]]
    silver_merge_key_review_artifact: Optional[Dict[str, Any]]
    silver_merge_key_review_decision: Optional[str]
    ...
    gold_metadata_drafts: Optional[List[Dict[str, Any]]]
    gold_metadata_rejections: Optional[List[Dict[str, Any]]]
    gold_transformation_objects: Optional[List[Dict[str, Any]]]
    silver_to_gold_mapping_bundles: Optional[List[Dict[str, Any]]]
    metadata_runtime_queue: Optional[List[Dict[str, Any]]]
    ...
    stage_statuses: Optional[Dict[str, str]]
    stage_outputs: Optional[Dict[str, Any]]
    stage_errors: Optional[Dict[str, str]]
    pipeline_revision: Optional[int]
    graph_thread_id: Optional[str]
    connection_id: Optional[str]
    sftp_memory_context: Optional[Dict[str, Any]]
    memory_check_status: Optional[str]
    metadata_bootstrap: Optional[Dict[str, Any]]
    metadata_bootstrap_status: Optional[str]
    sealed_plan: Optional[Dict[str, Any]]
    plan_seal_status: Optional[str]
    freshness_manifest: Optional[Dict[str, Any]]
    freshness_check_status: Optional[str]
    metadata_codegen_artifact: Optional[Dict[str, Any]]
    metadata_codegen_status: Optional[str]
