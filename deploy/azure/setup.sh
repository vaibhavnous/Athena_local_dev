...
read -p "Enter Azure SQL host: " SQL_HOST
read -p "Enter Azure SQL username: " SQL_USERNAME
read -s -p "Enter Azure SQL password: " SQL_PASSWORD
echo ""
...
echo "   - deploy/azure-pipelines/backend.yml → Name: 'Athena-Backend-CI'"
echo "   - deploy/azure-pipelines/frontend.yml → Name: 'Athena-Frontend-CI'"
