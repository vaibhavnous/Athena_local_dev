...
function buildDemoPipelineSteps(run: any) {
  if (run.id === 'run_a3f8c2') {
    return [
      ...
      { key: 'profiling', label: 'Column Extraction', state: 'PENDING' },
      { key: 'enrichment', label: 'Column Extraction', state: 'PENDING' },
      { key: 'gate3', label: 'Column Review', state: 'PENDING' },
  ...
  if (run.id === 'run_b7e1d3') {
    return [
      ...
      { key: 'profiling', label: 'Column Extraction', state: 'COMPLETED' },
      { key: 'enrichment', label: 'Column Extraction', state: 'COMPLETED' },
      { key: 'gate3', label: 'Column Review', state: 'COMPLETED' },
