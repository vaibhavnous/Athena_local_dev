...
# Databricks source JDBC secrets (non-secret references)
ATHENA_SOURCE_JDBC_SECRET_SCOPE=<databricks-secret-scope>
ATHENA_SOURCE_JDBC_USER_SECRET_KEY=AZURE_SQL_SOURCE_USERNAME
ATHENA_SOURCE_JDBC_PASSWORD_SECRET_KEY=AZURE_SQL_SOURCE_PASSWORD
